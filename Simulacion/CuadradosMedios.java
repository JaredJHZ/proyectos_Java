...
class AlgoritmoCuadradosMedios extends JFrame
{ 
 ...
 JTextField t1,t2, t3;
 JTextArea a1, a2, a3;
 int n=0, ntamano=0, ctamano=0, cuadrado=0;
 ...
 public AlgoritmoCuadradosMedios()
 {
  setSize(350,350);
  //setResizable(false);  // Limita el tamaño de la ventana
  setTitle("Algoritmo de Cuadrados");
  setVisible(true);
  ...
  restricciones.fill=GridBagConstraints.BOTH;
   ...
   l1=new JLabel("Algoritmo de Cuadrados");
   l1.setFont (new Font ("Book Antiqua", Font.BOLD, 30));
 ...
 //----- Valor de X0 -----  
   ...
   l2.setFont(new Font("Book Antiqua",Font.BOLD,14));
   ...
   t1.setBorder(BorderFactory.createMatteBorder(2, 1, 2, 1, Color.GRAY));
 ...
 //----- Cantidad de numeros a generar -----
   l3=new JLabel("Cantidad de numeros a generar:");
   l3.setFont(new Font("Book Antiqua",Font.BOLD,14));
   ...
   t2.setBorder(BorderFactory.createMatteBorder(2, 1, 2, 1, Color.GRAY));
   ...
   b1.setFont(new Font("Book Antiqua",Font.BOLD,14));
   ...
   b2.setFont(new Font("Book Antiqua",Font.BOLD,14));
   ...
   l4=new JLabel("Yi");
   l4.setFont(new Font("Book Antiqua",Font.BOLD,14));
   ...
   a1.setBorder(BorderFactory.createMatteBorder(3, 1, 3, 1, Color.GRAY));
   ...
   l5=new JLabel("Xi");
   l5.setFont(new Font("Book Antiqua",Font.BOLD,14));
   ...
   a2.setBorder(BorderFactory.createMatteBorder(3, 1, 3, 1, Color.GRAY));
   ...
   l6=new JLabel("Ri");
   l6.setFont(new Font("Book Antiqua",Font.BOLD,14));
   ...
   a3.setBorder(BorderFactory.createMatteBorder(3, 1, 3, 1, Color.GRAY));
  ...
  private class ManejadorCamposTexto implements ActionListener
 {
  public void actionPerformed(ActionEvent evento)
  {
   if (evento.getSource()==b1)
   {
    ...
    veces=Integer.parseInt(t2.getText());
     ...
     if(veces<=0)
     {
      JOptionPane.showMessageDialog(null,"Dato invalido, debe ser mayor a 0");
      t2.setText("");
     }
     ...
     else
     {
      ...
      {     
       cuadrado=n*n;
       String cua=String.valueOf(cuadrado);
       ctamano=cua.length();
